...
public class AutoLearnController {
    ...
    public static void learn(HttpServletRequest request, String[] kcIdList) {
        ...
        AutoLearnLogic.learn(userInfoDto);
    }
    ...
    public static void getCaptchaImg(HttpServletRequest request, String idCard, String password) {
        ...
        AutoLearnLogic.getCaptchaToken(request, userInfoDto);
    }
